...
function displayResults(resultsString) {
    ...
    for(let i = 0; i < resultsJS.results.length; i++) {
        ...
        <tr>
            ...
            <td>
                <td><input> type="checkbox" name="rem_song" id="remove_box"></td>
            </td>
        </tr>
        `;
...
const changeBGcolor = () => {
    document.body.style.backgroundColor = document.getElementById('bgInput').value;
}
...
document.getElementById('bgInput').addEventListener('change', changeBGcolor);
